...
![Screenshot Tampilan Hero Dekstop](Web-Dekstop/1.png)
...
![Screenshot Tampilan Layanan Dekstop](Web-Dekstop/2.png)

### 3. Portfolio Pilihan

Menampilkan cuplikan proyek-proyek terpilih seperti **Project Alpha**, **Studio Beta**, dan **Product X**.

![Screenshot Tampilan Portfolio Dekstop](Web-Dekstop/3.png)
...
![Screenshot Tampilan Kontak Dekstop](Web-Dekstop/4.png)
...
![Screenshot Tampilan Hero Mobile](Web-Mobile/1.png)

### 2. Layanan Utama Mobile

![Screenshot Tampilan Layanan Mobile 1](Web-Mobile/2.png)
![Screenshot Tampilan Layanan Mobile 2](Web-Mobile/3.png)

### 3. Portfolio Mobile (Project Alpha)

Salah satu contoh detail proyek yang ditampilkan.

![Screenshot Tampilan Portfolio Mobile](Web-Mobile/4.png)

### 4. Formulir Konsultasi Mobile

Formulir yang disederhanakan untuk pengalaman pengguna mobile yang lebih baik.

![Screenshot Tampilan Formulir Mobile](Web-Mobile/6.png)
